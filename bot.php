<?php 
define('BOT_TOKEN', '5199680640:AAGCuhbupP3t5fWsH8DL3TAG4OtIYJnI4bI'); 
...
function processaCallbackQuery($callback){
  $BOT_TOKEN = "5199680640:AAGCuhbupP3t5fWsH8DL3TAG4OtIYJnI4bI";
...
*Escolha uma das opções a baixo e clique no botão correspondente.*',
		    'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'➕ Adicione-me a um grupo ➕','url'=>'https://t.me/HidraBotConsultas?startgroup=start')                                           
                                                      ),
                                                     //linha 2
                                                     array(
...
*Escolha uma das opções a baixo e clique no botão correspondente.*',
       ...
       if($data_array['id']==$callback['from']['id']) {  
          ...
          if(!stripos($adms, "HidraBotConsultas")) {         
...
function processMessage($message) {
    ...
    if (isset($member_name) && $is_bot != '1') {
		if ($member_user !== 'HidraBotConsultas') {
...
Conheça abaixo, todos os meus comandos:*', "reply_to_message_id" => $message_id,
         ...
         } else if($member_user == 'HidraBotConsultas') {
...
*Meu nome é @HidraBotConsultas. Adicione-me em um grupo e me coloque como Admin para utilizar todos os meus recursos!
...
define('WEBHOOK_URL', 'https://consultabothidra.herokuapp.com/');
